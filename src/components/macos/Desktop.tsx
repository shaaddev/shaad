...
export const Desktop: React.FC = () => {
      ...
      content: (
        <div className="flex flex-col h-full">
          <div className="h-8 bg-gray-100 dark:bg-gray-800 flex items-center px-2 gap-2 border-b">
            <div className="flex-1 bg-white dark:bg-black/50 rounded px-2 text-sm py-0.5">
              https://shaaddev.com
            </div>
          </div>
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-[url('https://images.unsplash.com/photo-1464983953574-0892a716854b?q=80&w=2340&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center font-sans">
...
const DesktopIcon: React.FC<{
  ...
  <button
    onClick={onClick}
    className="group flex flex-col items-center gap-1 w-20 p-2 rounded hover:bg-white/20 transition-colors"
  >
