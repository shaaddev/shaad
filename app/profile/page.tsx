...
export default function Profile(){
    return (
        <main className="flex flex-col items-center justify-between p-10 md:p-10">
            <div className="flex flex-col md:grid gap-10 md:grid-cols-2 text-black dark:text-neutral-200 md:items-center">
                <Card className="grayscale hover:filter-none hover:cursor-pointer w-auto h-[400px] rounded-2xl bg-[url('/images/me/me.jpg')] bg-cover bg-center border-none" />
