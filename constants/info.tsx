...
export const projects: Projects[] = [
    ...
    },
    {
      ...
      techStack: ['Next.js', 'Tailwind CSS', 'OpenAI', 'Pinecone', 'Shadcn', 'Clerk'],
    ...
    },
    {
        ...
        techStack: ['Next.js', 'PostgreSQL', 'Tailwind CSS', 'DaisyUI', 'KindeAuth'],
    ...
    },
    {
        ...
        techStack: ['Next.js', 'PostgreSQL', 'Tailwind CSS', 'Shadcn', 'AWS', 'KindeAuth'],
